...
@Component({
  selector: 'app-accridifycertificate',
  templateUrl: './accridifycertificate.component.html',
  styleUrls: ['./accridifycertificate.component.scss']
})
export class AccridifycertificateComponent implements OnInit {
  viewId: any;
  p: any;
  searchText;
  page = 1;
